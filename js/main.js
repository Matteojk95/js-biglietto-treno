...
etapasseggero= parseInt (latuaeta);
...
let inputchilometri= document.getElementById("inputchilometri").value;
let inputetapassenger= document.getElementById("inputetapassenger").value;



let pricevoyage= (inputchilometri *0,21);

if (inputetapassenger < 18) {
    pricevoyage * 20 / 100
} else if (inputetapassenger > 65) {
    pricevoyage * 40 / 100
} else {
    pricevoyage
}
